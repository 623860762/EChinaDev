			...
			<div class="news_content_line">
				<div class="news_left_div">
					<div class="left_menu_div">
						...
						<ul id="leftMenu">
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=0">招标资讯</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=1">项目预告</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=2">采购公告</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=3">资格预审</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=4">变更公告</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=5">评审公示</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=6">结果公告</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=7">行业动态</a></div></li>
						<li><div class="font02"><a href="news_second_naviTool_temp.jsp?type=8">政策法规</a></div></li>
						</ul>	
					</div>
				</div>

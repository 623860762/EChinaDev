			...
			<div class="news_content_line">
				<div class="news_left_div">
					<div class="left_menu_div">
						...
						<ul id="leftMenu">
						<li><div class="font02"><a href="news_second_supplier_temp.jsp?type=0">查看业务信息</a></div></li>
						<li><div class="font02"><a href="news_second_supplier_temp.jsp?type=1">了解组织结构</a></div></li>
						<li><div class="font02"><a href="news_second_supplier_temp.jsp?type=2">解读政策法规</a></div></li>
						<li><div class="font02"><a href="news_second_supplier_temp.jsp?type=3">关注工作动态</a></div></li>
						</ul>	
					</div>
				</div>

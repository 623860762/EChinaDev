...
<%
	...
	String columTitle = request.getParameter("columTitle")==null?"":request.getParameter("columTitle");
	columTitle = java.net.URLDecoder.decode(columTitle);
	System.out.print(columTitle);
...
<link rel="stylesheet" type="text/css" href="<%=path%>/skin/css/news_details.css"/>
</head>
<body>
	<div align="center">
		...
		<div class="news_content_div">
			<div class="head_div">
    			<span class="current_place"><span class="current_place_word">当前位置：首页 &gt; 招标采购  &gt; 招标公告</span></span>
    			<span class="current_title">物资信息</span>
    			<div class="project_num"></div>
			</div>
			<span class="head_time"></span>

			...
			<div class="news_content_line">
				<div class="news_left_div">
					<div class="left_menu_div">
						...
						<ul id="leftMenu">
						<li><div class="font02"><a href="news_second_download_temp.jsp?type=0">操作手册</a></div></li>
						<li><div class="font02"><a href="news_second_download_temp.jsp?type=1">培训视频材料</a></div></li>
						<li><div class="font02"><a href="news_second_download_temp.jsp?type=2">CA证书办理及安装</a></div></li>
						<li><div class="font02"><a href="news_second_download_temp.jsp?type=3">离线投标工具安装</a></div></li>
						</ul>	
					</div>
				</div>

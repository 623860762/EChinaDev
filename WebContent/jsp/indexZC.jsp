		...
		<div class="bidHall_sysPub w1019 margin_top20">
			<div class="bidHall_div">
				<div class="bid_hall_head_div">
					<span class="head_span"><ul><li class="head_ul_blueIcon"></li></ul><h1 class="h1_font">招标大厅</h1></span>
				</div>
				<div class="bid_hall_cont_div">
					<ul class="hold-news clearfix">
		            <li data-id="0" class="active"><span></span>正在招标<p style="color:#4D2679;display:inline;position:relative;left:27px;">|</p><a href="" class="hmore" style="width:60px;color:#47a6dc;border:1px solid red;">更多&gt;&gt;</a></li>
		    		<li data-id="1"><span></span>即将开标<p style="color:#4D2679;display:inline;position:relative;left:27px;">|</p><a href="" class="hmore" style="color:#47a6dc;">更多&gt;&gt;</a></li>
		            <li data-id="2"><span></span>正在公示<a href="" class="hmore" style="color:#47a6dc;">更多&gt;&gt;</a></li>
		    		</ul>
		    		<div class="bid_hall_cont_news">
		    			<ul class="cont_news_lasTime" data-id="0" style="display:block;">
		    			...
		    			<ul class="cont_news_lasTime" data-id="1" style="display:none;">
		    			...
		    			<ul class="cont_news_lasTime" data-id="2" style="display:none;">

			...
			<div class="news_content_line">
				<div class="news_left_div">
					<div class="left_menu_div">
						...
						<ul id="leftMenu">
						<li><div class="font02"><a href="news_second_question_temp.jsp?type=0">招标前准备</a></div></li>
						<li><div class="font02"><a href="news_second_question_temp.jsp?type=1">招标采购业务</a></div></li>
						<li><div class="font02"><a href="news_second_question_temp.jsp?type=2">非招标采购业务</a></div></li>
						<li><div class="font02"><a href="news_second_question_temp.jsp?type=3">其它供应商相关问题</a></div></li>
						</ul>	
					</div>
				</div>
